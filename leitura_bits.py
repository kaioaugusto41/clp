...
while True:
    ...
    c = ModbusTcpClient(host='10.180.1.250', port=502, timeout=999999)                                                                # Faz a conexão com o CLP
            ...
            if not status_linha.isError():                                                                            # Se não ocorrer nenhum erro na leitura do valor...                                                      
                if status_linha.bits[0] == True and not status_linha.isError():                                       # Se o índice 0 do valor retornado for verdadeiro e tiver algum erro...
                    while status_linha.bits[0] == True or status_linha.isError():                                     # Enquanto o índice 0 do valor retornado for verdadeiro ou tiver algum erro...
                        ...
                        print('Valor durante o teste: ', converte_valores(c.read_holding_registers(12004, 10)))
                        time.sleep(0.5)                                                                                 # Pausa no código de 1 segundo.  
                        ...
                        if not status_linha.isError():                                                                # Se não tiver nenhum erro na variável do status da linha...
                            ...
                            while True:                                                             # Enquanto houver erro na variável status_linha...
                                print('erro 1')
                    ...
                    if not corrente_media.isError():                                                                  # Se não tiver erro na variável corrente_media e a corrente média não for igual a 'nan'...
                        if converte_valores(corrente_media) == 'nan':                                                 # Se o valor recebido foi igual a 'nan' ignora o teste...
                            print('O teste foi ignorado pois deu "nan"')
                        else:                                                                                         # Mas se o valor retornado não foi igual a 'nan'...
                            print('Valor salvo no banco: ', converte_valores(corrente_media))
                        ...
                        while True:                                                                                   # Enquanto verdadeiro...  
                            ...
                            if not corrente_media.isError():                                                          # Verifica novamente se não há nenhum erro na variável correte_media
                              if converte_valores(corrente_media) == 'nan':                                           # Se o valor recebido foi igual a 'nan' ignora o teste...
                                print('O teste foi ignorado pois deu "nan"')
                                break                                                                                 # Para o loop
                            else:                                                                                     # Mas se o valor retornado não foi igual a 'nan'...
